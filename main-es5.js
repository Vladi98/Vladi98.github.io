...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getData().subscribe(function (d) {
            _this.myData = d;
            console.log(d);
        });
    };
    AppComponent.prototype.displayResults = function () {
        var _this = this;
        return this.getData().subscribe(function (d) {
            d.includes(_this.searchText);
        });
    };
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(service, log, route) {
        this.service = service;
        this.log = log;
        this.route = route;
    }
...
var AuthenticationComponent = /** @class */ (function () {
    function AuthenticationComponent(service, myRoute) {
        this.service = service;
    ...
    AuthenticationComponent.prototype.registerUser = function () {
        var _this = this;
        this.service.registerUser(this.register).subscribe(function (response) {
            alert('User ' + _this.register.username + ' registered successfully');
...
var BedsSofasComponent = /** @class */ (function () {
    function BedsSofasComponent(service) {
        this.service = service;
    }
    BedsSofasComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getBeds().subscribe(function (res) {
            _this.items = res.filter(function (x) { return x.category == 1; });
        });
    };
    BedsSofasComponent.prototype.getBeds = function () {
        return this.service.getFurnitures();
    };
    BedsSofasComponent.ctorParameters = function () { return [
...
var ChairsComponent = /** @class */ (function () {
    function ChairsComponent(service) {
        this.service = service;
    }
    ChairsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getChairs(1).subscribe(function (res) {
            _this.chairs = res.filter(function (x) { return x.category == 2; });
        });
    };
    ChairsComponent.prototype.getChairs = function (id) {
        return this.service.getFurnitures();
    };
    ChairsComponent.ctorParameters = function () { return [
        { type: src_app_services_furnitures_service__WEBPACK_IMPORTED_MODULE_2__["FurnituresService"] }
    ]; };
...
var TablesComponent = /** @class */ (function () {
    ...
    TablesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getTables().subscribe(function (res) {
            _this.tables = res.filter(function (x) { return x.category == 34; });
        });
    };
...
var FurnituresCarouselComponent = /** @class */ (function () {
    function FurnituresCarouselComponent(service, config) {
        this.service = service;
    ...
    FurnituresCarouselComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getData().subscribe(function (d) {
            _this.myData = d;
        });
    };
    FurnituresCarouselComponent.prototype.getData = function () {
        return (this.service.getFurnitures());
    };
    FurnituresCarouselComponent.ctorParameters = function () { return [
        { type: _services_furnitures_service__WEBPACK_IMPORTED_MODULE_2__["FurnituresService"] },
    ...
    return FurnituresCarouselComponent;
}());
...
var ItemsComponent = /** @class */ (function () {
    function ItemsComponent(service, config, modalService) {
        this.service = service;
    ...
    ItemsComponent.prototype.open = function (index) {
        var modalRef = this.modalService.open(_modal_popup_modal_popup_component__WEBPACK_IMPORTED_MODULE_4__["ModalPopupComponent"]);
    ...
    ItemsComponent.prototype.getData = function () {
        return (this.service.getFurnitures());
    };
...
var ModalPopupComponent = /** @class */ (function () {
    function ModalPopupComponent(activeModal) {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(service, myRoute) {
        this.service = service;
        this.myRoute = myRoute;
    ...
    LoginComponent.prototype.login = function () {
        var _this = this;
        this.service.generateToken(this.log).subscribe(function (response) {
            alert('User ' + _this.log.username + ' logged in successfully');
            _this.myRoute.navigate(['/home']);
        }, (function (error) {
            alert("Invalid credentials! Please try again!");
        }));
    };
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(service, registerService, router) {
        this.service = service;
    ...
    NavbarComponent.prototype.displayResults = function () {
        var _this = this;
        return this.getData().subscribe(function (d) {
            d.includes(_this.searchText);
        });
...
var FurnituresService = /** @class */ (function () {
    function FurnituresService(httpClient) {
        this.httpClient = httpClient;
        this.URL = "http://djangorestapidata.herokuapp.com/furnitures/";
    }
    FurnituresService.prototype.getFurnitures = function () {
        return this.httpClient.get(this.URL);
    };
    FurnituresService.ctorParameters = function () { return [
...
var RegistrationService = /** @class */ (function () {
    ...
    RegistrationService.prototype.registerUser = function (data) {
        return this.httpClient.post(this.URL + "/users/", data, { observe: 'response' });
    };
    RegistrationService.prototype.getUsers = function () {
        return this.httpClient.get(this.URL + "/users/");
    };
    RegistrationService.prototype.generateToken = function (data) {
        var _this = this;
        return this.httpClient.post(this.URL + "/auth/", data, { observe: "response" }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (x) { return _this.token = x.status; }));
    };
